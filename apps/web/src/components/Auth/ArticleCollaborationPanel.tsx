          ...
          {canManage && (
            <section className="space-y-3">
              ...
              <select
                ...
                className="w-full rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] px-3 py-2 text-[13px] focus:outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)] transition-all duration-[120ms] ease-out hover:border-[var(--border-hover)] cursor-pointer"
              >
            ...
            {canManage && (
              <form onSubmit={handleAddCollaborator} className="grid grid-cols-[minmax(0,1fr)_6.5rem_4rem] gap-2">
                ...
                <select
                  ...
                  className="rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] px-2 py-2 text-[13px] focus:outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)] transition-all duration-[120ms] ease-out hover:border-[var(--border-hover)] cursor-pointer"
                >
                ...
                <div key={collaborator.id} className="flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2">
                  ...
                  {canManage ? (
                    <select
                      ...
                      className="rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] px-2 py-1.5 text-xs focus:outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)] transition-all duration-[120ms] ease-out hover:border-[var(--border-hover)] cursor-pointer"
                    >
                      <option value="EDITOR">Editor</option>
                      <option value="VIEWER">Viewer</option>
                    </select>
